...
- run `swapenv load` to load the environments (all of them will disappear from your current directory)
- run `swapenv to <environment-name>` to swap environments. e.g.: `swapenv to dev`
